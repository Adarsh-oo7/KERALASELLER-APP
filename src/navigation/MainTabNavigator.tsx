...
function BottomTabs() {
  return (
    ...
    >
      ...
      <Tab.Screen name="Products" component={ProductListScreen} options={{ title: 'Products' }} />
      ...
      <View style={styles.drawerMenu}>
        {menuItems.map((item) => (
          ...
          >
            ...
            <Ionicons name="chevron-forward" size={16} color={COLORS.inactive} style={styles.drawerChevron} />
          </TouchableOpacity>
        ))}
      </View>
    </View>
...
// Main Drawer wrapping Bottom Tabs
